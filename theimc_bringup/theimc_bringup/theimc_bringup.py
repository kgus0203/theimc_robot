...
class BringUp(Node):
    ...
    def __init__(self):
        ...
        # --- 로봇 물리적 파라미터 ---
        self.wheel_separation = 0.7 # [m] 좌우 바퀴 간의 거리 (780mm)
        self.wheel_radius = 0.06     # [m] 바퀴의 반지름 (65mm)
        self.enc_resolution = 2500    # 엔코더 1회전당 펄스 수
        self.pulse_per_meter = self.enc_resolution / (2 * math.pi * self.wheel_radius)
        self.serial_write_delay = 0.007

        # --- 속도 제한 ---
        self.max_lin_vel_x = 0.15
        self.max_ang_vel_z = 0.3
