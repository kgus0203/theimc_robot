...
class Yolov26Node(LifecycleNode):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.declare_parameter("model","/home/jeff/theimc_robot/src/camera_perception_pkg/test/best_260803.pt")
        ...
        self.get_logger().info('Yolov24Node created')
    ...
    def perception_enable_cb(self, msg: Bool):
        ...
        if prev != self.enable:
            if self.enable:
                self.get_logger().info("[YOLOV26] perception ENABLED by topic")
            else:
                self.get_logger().info("[YOLOV26] perception DISABLED by topic")
    ...
    def image_cb(self, msg: Image) -> None:
        ...
        try:
            ...
            self.get_logger().error(f"[YOLOV26] image_cb error: {str(e)}")
